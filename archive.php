...
<main>
    <?php get_template_part("paths/breacrumb",null,['static'=>true,'type'=>'archive-news']); ?>
    <div id="blog_page">
        <div class="container">
            <div class="blog_box">
                <h1 class="page_title">
                ...
                <div class="blog_tabs">
                    <?php if (!empty($news_cats)): ?>
					     <div class ="all-cate">
							         <a href="<?php echo get_post_type_archive_link("news"); ?>" class="blog_tab active"
                            title="すべて">すべて</a> 
					    </div>
                         
					  <div class ="item-cate">
                        <?php foreach ($news_cats as $news_cat): ?>
                            <a class="blog_tab" href="<?php echo get_term_link($news_cat->term_id); ?>"
